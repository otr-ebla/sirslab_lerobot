...
> **Tip**
> This tutorial repository maintains the verified stable release of LeRobot as of June 5, 2025. Hugging Face has since rolled out a major upgrade to LeRobot that introduces many new features. To explore the latest tutorials, please refer to the official documentation.
...
> **Tip**
> SO-ARM100 and SO-ARM101 share the same code paths. SO-ARM100 users can adopt SO-ARM101 parameters directly.
